...
const Services = () => {
    return (
        ...
        <>
            <ReactPlayer url='/s.mp4' controls/>
            <div className={styles.container}>
                ...
                <div className={styles.block}>
                    ...
                    <ul className={styles.listServices}>
                        <li className={styles.listServices__item}><img className={styles.icon} alt={'icon'}
                                                                       src={botox}/> <a href={'#botox'}>Ботокс</a></li>
                        <li className={styles.listServices__item}><img className={styles.icon} alt={'icon'}
                                                                       src={plastic}/> <a href={'#plastic'}>Пластика</a>
                        </li>
                        <li className={styles.listServices__item}><img className={styles.icon} alt={'icon'}
                                                                       src={ceratin}/> <a href={'#ceratin'}>Кератин</a>
                        </li>
                        <li className={styles.listServices__item}><img className={styles.icon} alt={'icon'} src={sos}/>
                            <a href={'#sos'}>SOS-Уход</a></li>
                        <li className={styles.listServices__item}><img className={styles.icon} alt={'icon'}
                                                                       src={oilCream}/> <a href={'#oil'}>Масляный
                            уход</a></li>
                        <li className={styles.listServices__item}><img className={styles.icon} alt={'icon'} src={nano}/>
                            <a href={'#nanoplast'}>Нанопластика</a></li>
                        <li className={styles.listServices__item}><img className={styles.icon} alt={'icon'}
                                                                       src={piling}/> <a href={'#piling'}>Пилинг для
                            кожи головы</a></li>
                        <li className={styles.listServices__item}><img className={styles.icon} alt={'icon'}
                                                                       src={scissors}/> <a href={'#hair'}>Уход за
                            кончиками</a></li>
                    </ul>
